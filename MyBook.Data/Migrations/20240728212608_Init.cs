...
namespace MyBook.Data.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleTypeBook_SalesType_SaleTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubjectBook_Subjects_SubjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleTypeBook_BookId",
                table: "SaleTypeBook",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleTypeBook_SaleTypeId",
                table: "SaleTypeBook",
                column: "SaleTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_SubjectBook_BookId",
                table: "SubjectBook",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_SubjectBook_SubjectId",
                table: "SubjectBook",
                column: "SubjectId");
        }
